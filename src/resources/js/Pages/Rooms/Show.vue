      ...
      <div class="content-panel">
        <div class="main-content">
          ...
          <div class="right-panel">
            ...
            <p class="info"><span class="info-label">ランク:</span> <span class="info-value">{{ getRankText(room.host_rank, room.host_mr) }}</span></p>
            ...
            <p class="info"><span class="info-label">募集ランク範囲:</span> <span class="info-value">{{ getRankRangeText(room.min_rank, room.max_rank, room.min_mr, room.max_mr) }}</span></p>
          ...
          <div>
            <button v-if="isHost" @click="deleteRoom" class="action-button full-width danger">ルームを解散</button>
...
.modal-button {
  ...
  color: #6B4EF5; /* 紫文字に変更 */
  padding: 10px 15px; /* ボタンの余白を調整 */
  border: 2px solid #6B4EF5; /* 紫の境界線を追加 */
  border-radius: 8px;
  cursor: pointer;
  font-weight: bold;
  margin-top: 20px;
