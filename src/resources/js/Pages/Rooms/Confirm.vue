            ...
            <div class="form-container">
                ...
                <div class="input-group">
                    ...
                    <p v-if="formData.host_rank === 25000">
                        <span class="text-black">MR:</span> {{ formData.host_mr || '未設定' }} <span
                            class="text-black">MR</span>
                    </p>
                </div>
                ...
                <div class="input-group">
                    ...
                    <div class="character-list">
                        <div v-for="(character, index) in unwrapProxy(formData.host_characters) || []" :key="index"
                            class="character-card">
                            <img :src="getCharacterImage(character) || '/default-image.jpg'" alt="キャラクター画像"
                ...
                <div class="input-group">
                    ...
                    <div class="character-list">
                        <div v-for="(character, index) in formData.requested_characters || []" :key="index"
                            class="character-card">
                            <img :src="getCharacterImage(character) || '/default-image.jpg'" alt="キャラクター画像"
                                class="character-image" />
                        </div>
