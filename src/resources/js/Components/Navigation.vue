        ...
        <nav class="navigation-container">
            ...
            <div class="right-column">
                <div class="grid-container">
                    ...
                    <div class="grid-item text-left">
                        <svg v-if="!isLoggedIn" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="20"
                        ...
                        <svg v-else xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="20" height="20"
